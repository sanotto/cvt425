*SRCMBRTXT:Mensajes por ATM - Beneficiarios SIPA h
     ...
     C                   z-add     ANICAH        WWICAH            9 0
+----c                   if        ANIECJ <> 40 and ANIM01 < 2813
||   c                   ExSr      ChkCod
|    c                   ExSr      ChkCta
+----c                   EndIf
     C*-------------------------------------------------------------------------
...
+----c                   if        *in97 = '1'
|    c                   move      'AC'          E6ISUB
|    c                   z-add     ANISUC        E6ISUC
|    c                   z-add     ANICAH        E6ICCL
