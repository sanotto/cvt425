*SRCMBRTXT:Subrutina: Calc IRR-CFT sin IVA        
     H******************************************************************
     H*                                                                *
     ...
     H*                                                                *
     H*  PROGRAM NAME     : SBBACIR2                                   *
     H*                                                                *
     H*  PROGRAM TITLE    : PRESTAMOS-CALCULO DE IRR                   *
     H*                     Inspirado en SBBACIRR pero con otro campo  *
     H*                                                                *
     H******************************************************************
     H* CARGAR EN PRTEM1 EN P1$ACP LOS IMPORTES DEBE HABER AL MENOS    *
     H* UN IMPORTE NEGATIVO PARA QUE LA SERIE SEA CONVERGENTE          *
     H*                                                                *
     ...
     C                   ENDIF
     C                   ADD       1             TOTPER
     C                   EVAL      CF(TOTPER)=P1$ACP
     C     KS101         READE     REPRTEM1                               99
     C                   ENDDO
     C*
