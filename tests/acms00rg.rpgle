...
||+--c                   if        TAFAAL <= wwfven and TAFAAL = 0
|||  c                   exsr      PrtBody2
|||  c                   add       1             count
||+--C                   EndIf
|+---C                   EndIf
...
||+--c                   endif
|+---c                   endif
|    c* Imprime codigo de mensaje MSG022 - ALIAS CBU CLIENTES NBLR
|+---c     20170601      ifgt      AASFEI
||+--c                   if        mess = 'MSG022'
|||  C                   Eval      indo=%subst(line:037:008)
|||  c                   exsr      srextarj
|||+-c     wwntar        ifne      *zero
...
||+--c                   endif
|+---c                   endif
|    c* Imprime codigo de mensaje MSG033 - ALIAS CBU CLIENTES NBLR
|+---c     20190531      ifeq      AASFEI
||+--c                   if        mess = 'MSG033'
|||  C                   Eval      indo=%subst(line:037:008)
|||  c                   exsr      srextarj
|||+-c     wwntar        ifne      *zero
...
+----c                   EndIf
     ...
     c                   EndSr
     C*-------------------------------------------------------------------------
     c* PrtBody15:Imprime registros de detalle para mensaje 022
     C*-------------------------------------------------------------------------
     c     PrtBod15      BegSr
     c*
     c                   Eval      %subst(buf:001:002)='TD'
     ...
     C                                                %EDITW(
     C                                           TAIDIG:'0 '))
     c                   Eval      %subst(buf:022:006)='MSG022'
     c                   Eval      %subst(buf:028:002)='01'
     c                   Eval      %subst(buf:030:002)='10'
     c                   MOVE      'NI'          PACINV            2
     c                   Eval      %subst(buf:032:006)='170529'
     c                   Eval      %subst(buf:038:006)='170601'
     c                   Eval      %subst(buf:044:002)=X'0D'+X'25'
     c                   CALLP     write(fdo: %addr(buf): %size(buf))
     c*
     c                   EndSr
     C*-------------------------------------------------------------------------
     c* PrtBod16:Imprime registros de detalle para mensaje 033
     C*-------------------------------------------------------------------------
     c     PrtBod16      BegSr
     c*
     c                   Eval      %subst(buf:001:002)='TD'
     ...
     C                                                %EDITW(
     C                                           TAIDIG:'0 '))
     c                   Eval      %subst(buf:022:006)='MSG033'
     c                   Eval      %subst(buf:028:002)='01'
     c                   Eval      %subst(buf:030:002)='10'
     c                   MOVE      'NI'          PACINV            2
     c                   Eval      %subst(buf:032:006)='190603'
     c                   Eval      %subst(buf:038:006)='190710'
     c                   Eval      %subst(buf:044:002)=X'0D'+X'25'
     c                   CALLP     write(fdo: %addr(buf): %size(buf))
     c*
     c                   EndSr
     C*-------------------------------------------------------------------------
     c* PrtBod17:Imprime registros de detalle para mensaje 034
     C*-------------------------------------------------------------------------
     c     PrtBod17      BegSr
     c*
     c                   Eval      %subst(buf:001:002)='TD'
     ...
     C                                                %EDITW(
     C                                           TAIDIG:'0 '))
     c                   Eval      %subst(buf:022:006)='MSG034'
     c                   Eval      %subst(buf:028:002)='01'
     c                   Eval      %subst(buf:030:002)='10'
     c                   MOVE      'NI'          PACINV            2
     c                   Eval      %subst(buf:032:006)='190603'
