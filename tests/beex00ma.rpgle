*SRCMBRTXT:PROCESO DE EXTRACT BEE                 
     ...
     c                   exsr      proc_transfe
     c                   when      prefijo='PATRA'
     c                   exsr      proc_trinter
     c                   when      prefijo4='CBUG'
     c                   exsr      proc_trancbu
     c                   when      prefijo4='ORIX'
     c                   exsr      proc_tranori
     c                   when      prefijo4='DESX'
     c                   exsr      proc_trandes
...
|||| C                                   %EDITW(sumtot: '             ,  ')
     ...
     c                   endsr
     C*---------------------------------------------------------------------
     c     proc_tranori  begsr
     c*
     C                   eval      S1DACL=' Proc. Ext. Trans ORIX:'+filename
     c                   write     REBASCTM
     c                   eval      filename2=filename
     c                   eval      filename=%subst(filename:1:4)+'-'+
     c                                      %subst(filename:5)
     ...
     c                   endsr
     C*---------------------------------------------------------------------
     c     proc_trandes  begsr
     c*
     C                   eval      S1DACL=' Proc. Ext. Trans DESX:'+filename
     c                   write     REBASCTM
     c                   eval      filename2=filename
     c                   eval      filename=%subst(filename:1:4)+'-'+
     c                                      %subst(filename:5)
     ...
     c                   endsr
     C*---------------------------------------------------------------------
     c     proc_trinter  Begsr
     c*
     C                   eval      S1DACL=' Proc. Ext.Tr.INTERBAN:'+filename
     c                   write     REBASCTM
     c                   eval      filename2=filename
     c                   eval      filename=%subst(filename:1:4)+'-'+
     c                                      %subst(filename:5)
     ...
     c                   if        prefijo4='ORIX' or prefijo4='DESX'
     c                   eval      dia= %subst(filename:8:2)
     c                   eval      mes= %subst(filename:6:2)
     c                   endif
     c                   testn                   mes                  99
     c  n99              leavesr
     c                   testn                   dia                  99
