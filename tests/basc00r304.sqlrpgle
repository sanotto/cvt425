...
|+---C                   SELECT
||   C     TMIGRC        WHENEQ    '01'
||   C                   EVAL      CONDSC=' Pago Mín Argencard '
||   C                   EVAL      TRNCDE=' 61'
||   C     TMIGRC        WHENEQ    '02'
||   C                   EVAL      CONDSC=' Pago Mín Mastercard'
||   C                   EVAL      TRNCDE=' 61'
||   C     TMIGRC        WHENEQ    '03'
||   C                   EVAL      CONDSC=' Pago Mín VISA      '
||   C                   EVAL      TRNCDE=' 62'
||   C     TMIGRC        WHENEQ    '04'
||   C                   EVAL      CONDSC=' Pago Mín C. Franca '
||   C                   EVAL      TRNCDE=' 60'
|+---C                   OTHER
||   C                   EVAL      CONDSC=' Pago Mín Argencard '
||   C                   EVAL      TRNCDE=' 61'
|+---C                   ENDSL
|+---C                   IF        WK$SAL > 0
||   C                   EVAL      S1DACL='03 '+TRNCDE+' '+
||   C                             ' SUC:'+ %EDITW(TMISUC:'      0 ')+
||   C                             ' GRC:'+TMIGRC+
||   C                             ' NCT:'+%EDITW(TMINCT:'           ')+
||   C                             ' PER:'+%EDITW(WXFAAM:'    /  ')+
||   C                             ' CON:'+CONDSC
...
||   c                   Eval      WRISUC=TMISUC
||   c                   Eval      WRICCL=TMINCT
||   c                   Eval      WRFAAM=WXFAAM
||   c                   Eval      WRDAV1=CONDSC
||   c                   Eval      WR$IMP=TC$TOT
||   c*
||   C                   EXSR      AgrLinea
||   c*
...
||   C     @KEY03        CHAIN     ACMOVD11                           80
||+--C                   DOW       *IN80 = *OFF
|||+-C                   IF        GCIASC = *ZEROS
|||| C                   ADD       GC$IMP        WW$PAP
|||+-C                   ENDIF
|||  C     @KEY03        READE     ACMOVD11                               80
||+--C                   ENDDO
