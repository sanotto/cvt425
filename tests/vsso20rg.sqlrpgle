*SRCMBRTXT:Code Test  -SQL Din sal hacia PC .DBF-V
     ...
     ***************************************************************************
     ...
     C                   EVAL      FldLen=       SQLLEN
     C                   EVAL      FldTyp=x'43'
     c*                  //Char (Varying Lenght)
     C                   WHEN      SQLTYPE=455 OR SQLTYPE=456
     C                   EVAL      FldByt=       SQLLEN
     C                   EVAL      FldLen=       SQLLEN
     C                   EVAL      FldTyp=x'43'
     c*                  //Graphics (Varying Lenght)
     C                   WHEN      SQLTYPE=464 OR SQLTYPE=465
     C                   EVAL      FldByt=       SQLLEN
     C                   EVAL      FldLen=       SQLLEN
     C                   EVAL      FldTyp=x'43'
     c*                  //Graphics (Fixed Lenght)
     C                   WHEN      SQLTYPE=468 OR SQLTYPE=469
     C                   EVAL      FldByt=       SQLLEN
     C                   EVAL      FldLen=       SQLLEN
     C                   EVAL      FldTyp=x'43'
     c*                  //Long Graphics (Varying Lenght)
     ...
     C                   EVAL      QryStr='SELECT * FROM SDBFIL/ACCODI'
     C/Exec Sql
     C+ INCLUDE SQLDA
     C/End-Exec
     C/Exec Sql
