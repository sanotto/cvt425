*SRCMBRTXT:Aut.Federal-Inserta pedido de Aut. en P
     ...
     c                              or JVILCR = 18 or JVILCR = 19
     c                              or JVILCR = 22 or JVILCR = 1
     c                              or JVILCR = 2                         )
     ...
     C                   DoW       *In99 = *Off
     c                   If        JVILCR <> 16 AND JVILCR <> 22
     c                             AND JVILCR <> 1 AND JVILCR <> 2
...
|+---C                   ENDIF
     ...
     C                   EndDo
     C                   If        JVILCR = 16 OR JVILCR = 22
     C                             OR JVILCR = 1 OR JVILCR = 2
     C*  Acreditamos el crédito al cliente  (210)
     C*  Debitamos   el crédito al cliente  (339)
     C*  Acreditamos el crédito al comercio (439)
     C                   EVAL      MCFECH=AASFEI
     C                   EVAL      MCISUC=JVISUC
     C                   EVAL      MCINCR=JVINCR
     C                   EVAL      MCIDEG=JVIDEG
     ...
     C                   EVAL      MCEDSU=@CISUC
     C                   EVAL      MCICCL=@CICCL
     C* Testea Subsistema de la cuenta del comercio.
     c                   If        @CISUB = 'CC'
     C                   EVAL      MCIAPC=1
     C                   ELSE
     C                   EVAL      MCIAPC=2
