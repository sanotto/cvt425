*SRCMBRTXT:Sup.Adm.-Control de Supervisiones Alta 
     H DEBUG DATEDIT(*YMD)
     H*****************************************************************
     H*                                                               *
     H*  SYSTEM NAME: SIDEBA - SUPERVISIONES                          *
     H*               Valida Si transacción necesita supervisión      *
     H*                                                               *
     H*  PROGRAM NAME: BASU10RG                                       *
     H*                                                               *
     H*  PROGRAM NO:                                                  *
     H*                                                               *
     H*  DATE:     04.06.2015                                         *
     H*                                                               *
     H*  AUTHOR:   Cova, Carolina Inés - PR00543                      *
     H*                                                               *
     H*****************************************************************
     FSGPGMS    IF   E           K DISK
...
+----C                   ENDIF
     ...
     c                                    'superv. Alta de Cliente:   '
     C                   EVAL      MESSAGE=%TRIM(MESSAGE)+
     C                                    %trim(%EDITC(SAISUC:'3'))+'-' +
     C                                    %trim(%EDITC(SAITDO:'3'))+'/' +
     C                                    %trim(%EDITC(SAINDO:'3'))
     C*
     C     KOS00         CHAIN     REBAICCL                           99
     C   99              MOVE      *ALL'?'       OSNCCL
     C     KOT00         CHAIN     REBADCCL                           99
