...
+----C                   ENDIF
     ...
     C                   Z-ADD     *ZEROS        WWITMO            1 0
     C     PAIMCA        CHAIN     ACCODI                             80
+----C     *IN80         IFEQ      *ON
|    C                   MOVE      @MSG(5)       PAIERR
|    C                   EXSR      ENDPGM
<    C                   ELSE
|    C                   Z-ADD     FXITMO        WWITMO
+----C                   ENDIF
     C*   .......Válida Sucursal
     C                   EXSR      VALSUC
     C*   .......Testea la existencia y vigencia de la cuenta
...
+----C                   ENDIF
     ...
     C*
     C
     C*VALIDA EL VENCIMIENTO DEL CERTIF.DE SUPERVIVENCIA- COD. MOV <> 8
+----C     WWITMO        IFEQ      1
...
+----C                   ENDIF
     ...
     C                   PARM                    PAERR2
     C*
     C     PAERR2        IFNE      *BLANKS
     C                   MOVEL(P)  @MSG(09)      PAIERR
     C                   MOVEL     '209'         PAIERR
     C                   EXSR      ENDPGM
     C                   ENDIF
     C*
