*SRCMBRTXT:Riesgo de Liquidez-Exporta RILIQUIDEZ.T
     H DEBUG
     ...
     H*                                                               *
     H*  PROGRAM NAME: Gen. de Arch. RILIQUIDEZ.TXT                   *
     H*                                                               *
     H*  PROGRAM NO: BCRL00R3                                         *
     H*                                                               *
     H*  DATE:    08/06/2014                                          *
     H*                                                               *
     H*  AUTHOR: SO                                                   *
     H*                                                               *
     H*  REVISO: CAROLINA I. COVA                                     *
     H*                                                               *
     H*****************************************************************
     FBCRLIQ02  IF   E           K DISK
     ...
     c                             ' RECP(BCRL00R3)                          '+
     c                             ' SUBJECT(''Archivo RILIQUIDEZ.TXT    '') '+
     c                             ' FILE('''+%trim(txtFile)+''')'
     c*
     c                   Call      'QCMDEXC'
     c                   Parm                    CmdLine
...
+----C                   EndDo
     ...
     c     BuildReg      BegSr
     C*
     c                   Z-Add     RLIMON        WWIMON            3 0
     c                   If        RLIGCM = 115000
     c                   Z-Add     10            WWIMON
     c                   Z-Add     110000        RLIGCM
     c                   EndIf
     c                   If        RLIGCM = 125000
     c                   Z-Add     10            WWIMON
     c                   Z-Add     120000        RLIGCM
     c                   EndIf
     C     RL$IMP        DIV       1000          WW$IMP           11 0
     c                   If        RL$A05 <> 0
     c                   ADD       RL$A05        WW$IMP
     c                   EndIf
     c                   Clear                   buf
     ...
     c                   Eval      txtFile=%TRIM(OUTPAT)+'RILIQUIDEZ.TXT'
     C*
