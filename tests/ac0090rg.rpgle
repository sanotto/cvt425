*SRCMBRTXT:LINK-REFRESH DE MOVS DIARIOS PARA HOME 
     ...
     C                   ENDSR
      *-------------------------------------------------------------.
      * GEOCAH: Recupera descipción para el movimiento DE CA HISTOR.
      *-------------------------------------------------------------'
     C     GEOCAH        BEGSR
     C*
     C                   CALL      'BAPR00R7'
     ...
     C                   ENDSR
      *-------------------------------------------------------------.
      * GEOCCH: Recupera descipción para el movimiento DE CC HIST
      *-------------------------------------------------------------'
     C     GEOCCH        BEGSR
     C*
     C                   CALL      'BAPR00R7'
