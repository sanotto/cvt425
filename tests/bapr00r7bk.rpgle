*SRCMBRTXT:Obtiene CUIT-NOMBRE p/Transferencia    
     ...
     FSPTRTR04  IF   E           k DISK    RENAME(RESPTRTR:R4)
     C                   Select
     c                   When      PAIMCA = 264
     C                   ExSr      BusTrInmLink
     ...
     c*
     c*
     C     KTR0400       Chain     R4                                 99
     c                   If        *In99 = *Off
     c                   Eval      PAOBSO=%Trim(
     c                                      %EditW(trinin:'               ')
     c                                     ) +' '+
     c                                    %Trim(trNCCL)+' '+wwcodi
     c                   EndIf
     c*
     c                   EndSr
     c*-------------------------------------------------------------------------
