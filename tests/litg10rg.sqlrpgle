...
//=========================================================================
   ...
   //Si esta exceptuado no lo valido en el LIKMTR
   IF ode_excepciones_ok = *off;
      leavesr;
   endif;
...
//==============================================================================
  // Verificar archivo de exepciones
//==============================================================================
 BEGSR verificar_excepciones;

 ode_excepciones_ok = *on;
 //consulto si la persona esta agregada como excepcion
 EXEC SQL
          SELECT
            COUNT(*)
            INTO :exep_val
           ...
           WHERE
            EXISUB = 'OD'           AND
            EXICAH = :nro_documento AND
            EXICCC = 0
           LIMIT 1;

   if exep_val <> 0 ;
      ode_excepciones_ok = *off;
      //Marco registro
      EXEC SQL
          UPDATE BAEXEP
           SET
