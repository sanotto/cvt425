*SRCMBRTXT:Formularios: Parser de Etiquetas format
     D*----------------------------------------------------------------*
     D* Programa generado a partir del programa modelo SBFP00RG.       *
     D* Se modifico para mostrar el formato numerico xxx.xxx,xx.       *
     D* 17/04/2009                                                     *
     D*----------------------------------------------------------------*
     D*
     ...
     D   chrEBCDIC                    1A   CONST
      ...
      /COPY SDB02.SRC/QRPGSRC,SBFP00HH
