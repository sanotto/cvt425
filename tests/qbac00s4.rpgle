*SRCMBRTXT:Rechazar Registros Seleccionados-Carga 
     H*  SYSTEM NAME: SIDEBA - CAJA DE AHORRO
     H*
     H*  PROGRAM NAME: QBAC00S4
     H*
     H*  PROGRAM NO: Rechazar Registros Seleccionados - Carga Archivo
     H*
     H*  DATE:  23/10/2018
     H*
...
+----c                   EndIf
     c                   ExSr      EndPgm
     c**********************************************************************
     c*Rechazar: Rechazar Lote
     c*-------------------------------------------------------------------------
     c     Rechazar      BegSr
     c*
     c                   SetOff                                           10
     c
+----c                   If        QZINI1= 'I' and QZINI2= *Blanks
|+-- c                   If        QZDF01= 'LOTE YA FUE PROCESAD' Or
||   c                             QZDF01= 'LOTE NULO           ' Or
||   c                             QZDF01= 'INTEGRIDAD ARCHIVO  ' Or
||   c                             QZDF01= 'FALTA PARAMETROS    ' Or
||   c                             QZDF01= 'LOTE NO FUE AUT.P   '
||   c                   SetOn                                            10
|+---c                   EndIf
+----c                   EndIf
     c*
...
||+--c                   Enddo
     c                   callp     closef(fdo)
||   c*....Envia Correo Informando Rechazo
||   c                   ExSr      Correo
...
+----c                   End
     ...
     c                   EndSr
     C*-------------------------------------------------------------------------
     c*Correo: Envia Correo Informando Rechazo
     c*-------------------------------------------------------------------------
     c     Correo        BegSr
     c
     c*====================
     c*Envio Correo Externo
     c*====================
...
|    c                                     LOTE RECHAZADO.................'
>    c                   Else
|    C                   Eval      %Subst(ASUNTO:001:028)='Acr.Sueldo: +
|    c                                     LOTE RECHAZADO. '
|    C                   Eval      %Subst(ASUNTO:029:020)= QZDF01
+----c                   EndIf
