*SRCMBRTXT:LINK:TRANSF.REDES-VER1-ANALIZA C.C.    
     ...
     H*                                                                *
     H*  PROGRAM TITLE    : GENERA MOVIMIENTOS EN LITERH-CUENTA CORRIEN*
     H*                                                                *
...
+----c                   EndIf
     ...
     c*              Si se encuentra el registro LITERHRESETCC0000012345678901
     c*              En el archivo LISERJ, se generará una baja para cada reg.
     c*              que hubiera en el LITERH y se generará una nueva alta
     C*-------------------------------------------------------------------------
     c     DetEstReset   BegSr
     c*
     c                   Move      *Off          Resetear          1
     c                   Move      *Blanks       WWDACO           30
     C                   Move      BMISUC        WWISUC            5
     C                   Move      BMICCC        WWiCAH           11
     c                   Eval      WWDACO = 'LITERHRESETCC'+
     c                                      WWISUC+
     c                                      WWICAH
     c*
