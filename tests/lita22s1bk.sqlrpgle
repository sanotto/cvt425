...
dcl-proc main;
    ...
    //Formatear Strings.
    dcl-c up              'AABCDEFGHIJKLMNNOPQRSTUVWXYZ'     ;
    dcl-c lo              'Áabcdefghijklmn¦opqrstuvwxyz'     ;
    dcl-c emp             '                           '      ;
    dcl-c Symbols         '|°¬!"#$%&/()=?\¡¿*+~¢]{}_-;,:.<>' ;
    dcl-c SymBlanks       '                                ' ;
    ...
    begsr alta_clientes_sin_tds;
        ...
        exec sql INSERT INTO LIKMAS (
         ...
         SELECT DISTINCT
                 ...
                 ELSE SUBSTRING(:clientes.numeracion, 1, 5) END,
                 '00',
                 '',
                 SUBSTRING(UPPER(TRIM(:clientes.localidad)), 1, 20),
                 0 || UPPER(TRIM(:clientes.codigo_postal)),
                 '12',
                 :clientes.telefono,
                 '...................',
                 '',
                 ...
                 '......................................' ||
                 '.........................',
                 '.' || TRIM(REPLACE(:clientes.telefono, '-', ' '))        ||
                 SUBSTRING(TRIM(:clientes.correo), 1, 34)                  ||
                 '....'                                                    ||
                 '..................................................'      ||
                 '..................................................'      ||
                 '..................................................',
        ...
        if (grupo_cliente = '04' AND sub_grupo_cliente = 'AN');
    ...
    if (cantidad_tarjetas > 1);
        ...
        exec sql SELECT DISTINCT
                 ...
                 INNER JOIN ACCTAC ON  FUICAH = TAICCL AND
                                       FUISUC = OTISUC
                 WHERE
                 FUFBAJ = 0 AND OTINDO = :clientes.dni
                 ORDER BY TAFALT DESC;
...
//==============================================================================
    ...
    begsr alta_clientes_tds;
        ...
        if (grupo_td = '04' AND (sub_grupo_td = 'JU' OR sub_grupo_td = '') AND
            td_baja  > 0);
        ...
        if (grupo_td = '04' AND sub_grupo_td = 'AN' AND td_baja > 0);
