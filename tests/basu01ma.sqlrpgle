*SRCMBRTXT:Sup.Adm.-Adm. de Supervisiones de PF   
     H DEBUG DATEDIT(*YMD)
     H*****************************************************************
     H*                                                               *
     ...
     FBASUMS    IF   E           K DISK
     F*
     F*PRLICR    IF   E           K DISK
     FPFCERT    UF   E           K DISK
     FBAICCL    IF   E           K DISK
     FBADCCL01  IF   E           K DISK
     F*PRICTA    IF   E           K DISK
     F*
