...
//==============================================================================
    ...
    begsr inicializar_en_maestro_anses_y_eliminar_acreditacion;
        ...
        if (maestro_anses = '2' AND PAFECH > %Dec(aasfei:8:0) AND
            ...
            if (%Subst(%Char(periodo):5:2) = '01' OR
                %Subst(%Char(periodo):5:2) = '03' OR
                %Subst(%Char(periodo):5:2) = '05' OR
                %Subst(%Char(periodo):5:2) = '07' OR
                %Subst(%Char(periodo):5:2) = '09' OR
                %Subst(%Char(periodo):5:2) = '11');
                cod_mov = 248;
            else;
                cod_mov = 247;
            endif;

            exec sql DELETE FROM ACMOVB
                        WHERE INISUC = :ANLIHA0.ANISUC AND
                              INICAH = :ANLIHA0.ANICAH AND
                              IN$IMP = :imp            AND
                              INICHE = :ANLIHA0.ANINBE AND
                              INIAYN = SUBSTR(:ANLIHA0.ANRENG, 13, 24) AND
                              INIMCA = :cod_mov;

            exec sql UPDATE ANLIHA SET ANHORA = 0,
                                       ANIFEA = 0,
                                       ANIPTA = 1,
                                       ANISUC = 0,
                                       ANICAH = 0,
...
//==============================================================================
    ...
    begsr grabar_retenciones_en_maestro_de_retenciones;
      ...
      VALUES (
             ...
             CAST(SUBSTR(:maestro_reten.nro_documento, 3, 9) AS DEC(8, 0)),
    ...
    begsr grabar_retenciones_para_informe;
        ...
        exec sql INSERT INTO QTEMP.ANMTEX(
                 ...
                 VALUES(
                        ...
                        SUBSTR(:maestro_reten.nro_documento, 3, 9),
                        :maestro_reten.cuil,
