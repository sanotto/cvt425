*SRCMBRTXT:Baja Archivo a /home/Camara            
     H DFTACTGRP(*NO) ACTGRP(*NEW)
     H BNDDIR('QC2LE'                                                          )
     FARCHIVO   IP   F  132        DISK
     ...
     ***************************************************************************
     ...
     C                   CallP     Cvt2Asc(%ADDR(lineac ):%LEN(lineac ))
     C                   EVAL      TipoArchivo=%TRIM(TipoArchivo)
     c                   if        TipoArchivo='EACIRS' or
     c                             TipoArchivo='EACIRP' or
     c                             TipoArchivo='EACIRR' or
     c                             TipoArchivo='EAFPRE' or
     c                             TipoArchivo='EARESE' or
     c                             TipoArchivo='EACIMP' or
     c                             TipoArchivo='EACIMR'
     c                   eval      buf   =linea+x'0d'+x'0a'
     c                   CALLP     write(FilHnd: %addr(buf   ): %size(buf   ))
     C                   Else
     c                   eval      bufc=lineac+x'0d'+x'0a'
     c                   CALLP     write(FilHnd: %addr(bufc  ): %size(bufc  ))
     c                   EndIf
     ...
     C     *INZSR        BEGSR
     C     *ENTRY        PLIST
     c                   Parm                    TipoArchivo      10
     C                   PARM                    FULPAT          512
     c                   EVAL      FULPAT=%TRIM(FULPAT)+X'00'
     c                   EVAL      FilHnd=open(fulpat :
