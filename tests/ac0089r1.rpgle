*SRCMBRTXT:LINK:TRANSF.REDES-VER1-ANALIZA C.A.    
     ...
     H*                                                                *
     H*  PROGRAM TITLE    : GENERA MOVIMIENTOS EN LITERH-CAJA DE AHORRO*
     H*                                                                *
...
+----C                   EndIf
     ...
     c*              Si se encuentra el registro LITERHRESETCA0000012345678901
