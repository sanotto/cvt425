*SRCMBRTXT:Switch-Adapter      -Manejador Principa
     ...
     D WKNTAR                604    622
     **..Nuevos campos agregados 23/05/2014 IF01 CONTIENE LA RED, RESTO FILLERS
     D WKIF01                623    632
     D WKIF02                633    642
     D WKIF03                643    652
     D WKIF04                653    662
     ...
     C                   Move      WKIF02        LRIF02
     C                   Move      WKIF03        LRIF03
     C                   Move      WKIF04        LRIF04
     C                   Move      WKIF05        LRIF05
     C*
...
>    C* GenPBF: Genera archivo PBF y envia a Servidor Switch
     ...
     C                   Move      LRIF02        WKIF02
     C                   Move      LRIF03        WKIF03
     C                   Move      LRIF04        WKIF04
     C                   Move      LRIF05        WKIF05
