*SRCMBRTXT:Host to Host -Consulta de Movs. Compras
     ...
     C                   ENDIF
     C*
     C* Si no es compra, chau! Y si no está rechazada...
     C     LRDBCO        IFEQ      8
     C     LRDBTC        ANDEQ     'CA'
     C     LRCOVE        ANDGT     0
     C     LRCORE        ANDEQ     0
     ...
     C     LRFING        ANDLT     20131203
     C                   Z-ADD     1,20          WW$POR            8 2
     C                   ENDIF
     C
     C* Percepción 35% S/RG 3550 Publicado en B.Oficial 32777
     C     LRFING        IFGE      20131203
     C                   Z-ADD     1,35          WW$POR            8 2
     C                   ENDIF
     C
     C*
